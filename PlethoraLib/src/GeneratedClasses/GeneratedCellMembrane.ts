...
export interface ICellMembranePropertiesValues {}

export abstract class GeneratedCellMembrane extends AbstractUiEntity {
  constructor(id: number, propertyValues: PropertyValuesDictionary) {
    super("Cell Membrane", id, propertyValues, [])
  }
  ...
  public static createRequest(
    propertyValues: Partial<ICellMembranePropertiesValues>,
    quantity: number,
    uiData: UiData = null
  ): void {

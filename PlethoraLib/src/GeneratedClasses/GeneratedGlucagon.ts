...
export interface IGlucagonPropertiesValues {}

export abstract class GeneratedGlucagon extends AbstractUiEntity {
  constructor(id: number, propertyValues: PropertyValuesDictionary) {
    super("Glucagon", id, propertyValues, [])
  }
  ...
  public static createRequest(
    propertyValues: Partial<IGlucagonPropertiesValues>,
    quantity: number,
    uiData: UiData = null
  ): void {

...
export interface IInsulinReceptorPropertiesValues {}

export abstract class GeneratedInsulinReceptor extends AbstractUiEntity {
  constructor(id: number, propertyValues: PropertyValuesDictionary) {
    super("Insulin Receptor", id, propertyValues, [])
  }
  ...
  public static createRequest(
    propertyValues: Partial<IInsulinReceptorPropertiesValues>,
    quantity: number,
    uiData: UiData = null
  ): void {

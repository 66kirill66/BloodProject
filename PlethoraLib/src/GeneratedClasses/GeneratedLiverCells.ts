...
export interface ILiverCellsPropertiesValues {
  "sugar level": number
}

export abstract class GeneratedLiverCells extends AbstractUiEntity {
  constructor(id: number, propertyValues: PropertyValuesDictionary) {
    super("Liver Cells", id, propertyValues, ["Cell"])
  }
  ...
  public static createRequest(
    propertyValues: Partial<ILiverCellsPropertiesValues>,
    quantity: number,
    uiData: UiData = null
  ): void {

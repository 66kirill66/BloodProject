...
export interface IMuscleCellsPropertiesValues {
  "sugar level": number
}

export abstract class GeneratedMuscleCells extends AbstractUiEntity {
  constructor(id: number, propertyValues: PropertyValuesDictionary) {
    super("Muscle Cells", id, propertyValues, ["Cell"])
  }
  ...
  public static createRequest(
    propertyValues: Partial<IMuscleCellsPropertiesValues>,
    quantity: number,
    uiData: UiData = null
  ): void {

...
export interface ISignalMolecule2PropertiesValues {
  AttachedToReceptor: boolean
}

export abstract class GeneratedSignalMolecule2 extends AbstractUiEntity {
  constructor(id: number, propertyValues: PropertyValuesDictionary) {
    super("Signal Molecule 2", id, propertyValues, [])
  }
  ...
  public static createRequest(
    propertyValues: Partial<ISignalMolecule2PropertiesValues>,
    quantity: number,
    uiData: UiData = null
  ): void {

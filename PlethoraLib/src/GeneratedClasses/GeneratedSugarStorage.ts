...
export interface ISugarStoragePropertiesValues {}

export abstract class GeneratedSugarStorage extends AbstractUiEntity {
  constructor(id: number, propertyValues: PropertyValuesDictionary) {
    super("Sugar Storage", id, propertyValues, [])
  }
  ...
  public static createRequest(
    propertyValues: Partial<ISugarStoragePropertiesValues>,
    quantity: number,
    uiData: UiData = null
  ): void {
